...
void unit_test_case0() {
    class ConcurrentHashMap<string, long long> testMap(26);
    testMap.InsertOrUpdate("test1", 1);
    long long result = -1;

    assert(testMap.GetValue("test1", result) == true);
    assert(result == 1);
    std::cout << "unit_test_case0 passed" << std::endl;
};
...
void unit_test_case1() {
    ...
    cout << "unit_test_case1 passed" << endl;
}
...
void unit_test_case2() {
    ...
    cout << "unit_test_case2 passed" << endl;
}
...
void unit_test_case3() {
    ...
    cout << "unit_test_case3 passed" << endl;
}
...
void unit_test_case4() {
    ...
    cout << "unit_test_case4 passed" << endl;
}


// Insert test0-test99, then read test0-test99
void *WriteAndRead1(void* arg) {
    class ConcurrentHashMap<string, long long>* testMap = (class ConcurrentHashMap<string, long long>*) arg;
    for(int i = 0; i < 100; i++) {
        testMap->InsertOrUpdate("test" + to_string(i), i);
    }
    long long result = -1;
...
void unit_test_case5() {
    ...
    cout << "unit_test_case5 passed" << endl;
}
...
void unit_test_case6() {
    ...
    cout << "unit_test_case6 passed" << endl;
}
